...
public class LeaderboardUI extends javax.swing.JFrame {
    ...
    public LeaderboardUI(User currentUser) {
    ...
    private void initComponents() {
        ...
        alphabeticSortButton.setBackground(Color.lightGray);

        winSortButton.setText("Sort By Wins");
        winSortButton.setBackground(Color.lightGray);

        wLRatioSortButton.setText("Sort by W/L Ratio");
        wLRatioSortButton.setBackground(Color.lightGray);

        filter.setText("Filter");

        filterTextArea.setText("Enter names separated by ,");

        filterButton.setText("Apply Filter");
        filterButton.setBackground(Color.lightGray);
        ...
        pack();
        LeaderboardController lbc = new LeaderboardController(this, currentUser);
    }
